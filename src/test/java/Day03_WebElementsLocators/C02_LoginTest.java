...
//      e. Expected user id nin testtechproed@gmail.com oldugunu dogrulayin(verify).
        ...
        System.out.println("girisYazisiElementi.getText()..:"+girisYazisiElementi.getText());
...
//      f. “Addresses” ve “Sign Out” textlerinin görüntülendiğini( displayed) doğrulayin(verify).
        ...
        System.out.println("Goruntulendi mi?..:"+addressWebElementi.isDisplayed());         // true veya false dondurecek
