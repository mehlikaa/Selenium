...
public class C07_ManageWindowSet {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Pozisyonu :"+driver.manage().window().getPosition());
        ...
        Thread.sleep(2000);
        driver.manage( ).window( ).setPosition(new Point(210,220));
        ...
        if (xKoordinati==210 && yKoordinati==220 && genislik==300 && yukseklik==500){
